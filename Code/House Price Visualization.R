...
Grouped_houseprice2 %>%
  filter(`Date of Transfer`==2019 | `Date of Transfer`==2020 | `Date of Transfer`==2021 |`Date of Transfer`==2022) %>% #filtering to show only houseprice data of 2019,2020,2021,2022
